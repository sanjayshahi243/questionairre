...
Run this after starting the MongoDB container.
"""
import os
import sys
import django
...
def init_mongo_data():
    """Initialize MongoDB with sample questions and forms."""
    try:
        # Connect to MongoDB
        ...
        form2.save()
        print(f"Created form: {form2.title}")
        
        print("\nMongoDB initialization completed successfully!")
        print(f"Created {len(questions)} questions and 2 forms")
        
    except Exception as e:
        print(f"Error initializing MongoDB data: {e}")
        raise
